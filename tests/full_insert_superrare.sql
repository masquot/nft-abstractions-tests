...
rows AS (
    ...
    a."to", -- original
    amount, -- original
    NULL::numeric, -- original_amount_raw
    'ETH', -- original_currency
    '\x0000000000000000000000000000000000000000'::bytea, --original_currency_contract
    '\xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2'::bytea, -- currency_contract
    'xb932a70a57673d89f4acffbe830e8ed7f75fb9e0'::bytea, -- nft_contract_address
    NULL::bytea, -- exchange_contract_address
    tx_hash, -- original
    NULL::integer, --int8 block_number
    NULL::bytea, -- tx_from,
    NULL::bytea, -- to" AS tx_to,
    NULL::integer[] AS call_trace_address,
    NULL::integer, --int8 evt_index
    -- "include" :todo: -- original
    -- (((gas_used * gas_price) / 10^18) * price) as gas_fee,  -- original
    FROM 
    all_activities a
